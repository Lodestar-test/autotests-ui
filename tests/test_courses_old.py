...
def test_empty_courses_list():
    ...
    with sync_playwright() as playwright:
        ...
        courses_word = page.get_by_test_id('courses-list-toolbar-title-text')
        expect(courses_word).to_be_visible()
        expect(courses_word).to_have_text('Courses')

        noresults_phrase = page.get_by_test_id('courses-list-empty-view-title-text')
        ...
        results_long_phrase = page.get_by_test_id('courses-list-empty-view-description-text')
